...
def exit_program():
    exit_string = input("Enter 'exit' to terminate : ")
...
while(1):
    try:
        file_path = input("Enter the file path of the SBOM File : || Enter 'exit' to terminate : ")
        ...
        printf("File path not found. Try again")
